...
const Cart = ({ width = 22, height = 20, styles }) => (
  <svg
    ...
    style={{ enableBackground: 'new 0 0 299.915 299.915' }}
    {...styles}
  >
    <g>
      <path
        d='M293.494,53.616H55.701c-0.463,0-0.88,0.174-1.318,0.27l-9.672-32.115c-0.109-0.347-0.341-0.604-0.495-0.925
